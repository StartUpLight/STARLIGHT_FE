...
export default function Header() {
    const navLink =
        "ds-text px-2 font-medium text-gray-800 transition-colors hover:text-primary-500 hover:font-semibold";
    const dropdownItem =
        "block px-[12px] py-[8px] ds-subtext font-medium text-gray-800 transition-colors hover:bg-primary-50 hover:text-primary-500";
    const menuWrapper =
        "relative group/nav";
    const menuButton =
        "ds-text px-2 font-medium text-gray-800 transition-colors hover:text-primary-500 hover:font-semibold group-hover/nav:text-primary-500 group-hover/nav:font-semibold focus:outline-none focus-visible:text-primary-500 focus-visible:font-semibold";
    const menuList =
        ...
        <header className="fixed inset-x-0 top-0 z-50 w-full bg-white shadow-[0_4px_6px_0_rgba(0,0,0,0.05)]">
            <div className="mx-auto flex h-[60px] items-center px-8">
                ...
                <div className="ml-auto flex items-center">
                    <Link
                        href="/login"
                        className="ds-text text-nowrap py-[6px] px-4 font-medium text-gray-800 transition-colors hover:text-primary-500 hover:font-semibold"
                    >
                        로그인
                    </Link>
                </div>
