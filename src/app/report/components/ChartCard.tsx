...
const ChartCard = () => {
  ...
  const labelDistances = [30, 40, 30, 60] as const;
  ...
  if (!planId) {
    return (
      <div className="flex h-[359px] min-w-[540px] items-center justify-center rounded-[12px] border border-gray-300 bg-white p-6">
